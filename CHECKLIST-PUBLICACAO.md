...
- [ ] Trocar o caminho relativo de `og:image` por uma URL absoluta
...
- [ ] Conferir a mensagem pré-preenchida
- [ ] Confirmar quem responderá aos contatos recebidos
- [ ] Definir tempo interno de resposta

## Privacidade

- [ ] Manter a política atual se o site continuar sem cookies e sem armazenamento
...
- [ ] Limpar o cache da hospedagem ou CDN após atualizações
